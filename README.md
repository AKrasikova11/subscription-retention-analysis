...
Проведена проверка различий retention между каналами с использованием t-test.

Результат:
- p-value ≈ 0 (1.28e-139)

Это означает, что различие между каналами является статистически значимым и не случайным.
